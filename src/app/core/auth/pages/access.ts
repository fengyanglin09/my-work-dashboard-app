                    ...
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                        <div class="gap-4 flex flex-col items-center">
                            <div class="flex justify-center items-center border-2 border-orange-500 rounded-full" style="width: 3.2rem; height: 3.2rem">
                                <i class="text-orange-500 fa fa-lock text-2xl!"></i>
                            </div>
                            ...
                            <div class="col-span-12 mt-8 text-center">
                                <a mat-flat-button routerLink="/" style="background-color: var(--mat-sys-tertiary, #f79530); color: #fff;">Go to Dashboard</a>
                            </div>
                        </div>
                    </div>
                </div>
